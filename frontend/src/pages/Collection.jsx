...
const Collection = () => {
    ...
    src={assets.dropdown || "fallback-image-url"}  
    alt="Toggle Filter"  
...
/>
                ...
                <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
                    ...
                    <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
                        ...
                        <p className='flex gap-2'>
                            <input className='w-3' type="checkbox" value={'Clothing & Apparel'} onChange={toggleCategory}/> Clothing & Apparel
                        </p>
                ...
                <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
                    ...
                    <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
                        ...
                        <p className='flex gap-2'>
                            <input className='w-3' type="checkbox" value={'Tees'} onChange={toggleSubCategory}/> Tees
                        </p>
                        ...
                        <p className='flex gap-2'>
                            <input className='w-3' type="checkbox" value={'Caps'} onChange={toggleSubCategory}/> Caps
                        </p>

                        <p className='flex gap-2'>
                            <input className='w-3' type="checkbox" value={'Mugs'} onChange={toggleSubCategory}/> Mugs
                        </p>
